...
eatureProbe brings about value to our daily development and operations in these aspects:
...
![FeatureProbe screenshot](https://github.com/FeatureProbe/FeatureProbe/blob/main/pictures/toggles.png) 
...
docker compose up
```
*For users in Mainland China, please refer to [configure mirror](https://github.com/FeatureProbe/FeatureProbe/blob/main/DOCKER_HUB.md) to speed up your download.*
...
Please read [CONTRIBUTING](https://github.com/FeatureProbe/FeatureProbe/blob/main/CONTRIBUTING.md) for details on our code of conduct, and the process for 
taking part in improving FeatureProbe.


## License

This project is licensed under the Apache 2.0 License - see the [LICENSE](https://github.com/FeatureProbe/FeatureProbe/blob/main/LICENSE) file for details.
